...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'renewal_date', '非法日期 - 日期太小')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'renewal_date', '非法日期 - 日期太大') 
        

class LoanedBookInstancesAllListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('all-borrowed'))
        self.assertRedirects(resp, '/accounts/login/?next=/catalog/allbooks/')
        
    def test_redirect_if_logged_in_not_have_permission(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('all-borrowed'))
        self.assertRedirects(resp, '/accounts/login/?next=/catalog/allbooks/') 
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        #Check we used correct template
        self.assertTemplateUsed(resp, 'catalog/bookinstance_list_borrowed_all.html')     
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = '2017/12/10'
